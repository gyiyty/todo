...
function TaskEditor({ task, lists, tags, defaultList, onClose, onSave, onDelete, onTagsChanged, notify }: {
  ...
  return <aside class="editor" aria-label={task ? '编辑任务' : '新建任务'}>
    ...
    <form id="task-form" class="editor-form" onSubmit={submit}>
      ...
      <label class="field"><span><CalendarDays />截止时间</span><input type="datetime-local" value={dueAt} onInput={e => setDueAt(e.currentTarget.value)} /></label>
